"""
Phase 1B: Extract Rare Variants from 36,000 ADSP Samples
전체 데이터셋 처리 - NO SAMPLING
"""
...
WORK_DIR = "/N/project/ADSP-AI/LD-rarevariant-5th-all"
ADSP_DATA_BASE = "/N/project/ADSP-AI/R4-2025/00-r4-compact-filtered-biallelic-from-adsp"
...
def save_population_checkpoint(population, status):
    """
    Save checkpoint for population processing
    """
...
def run_plink_rare_variant_extraction(population):
    """
    Run PLINK2 to extract rare variants for a specific population
    전체 36,000명 데이터 처리 - 샘플링 없음
    """
...
def merge_population_results():
    """
    Merge rare variant results from all populations
    """
...
def generate_variant_summary():
    """
    Generate comprehensive summary of rare variant extraction
    """
