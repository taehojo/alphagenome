"""
Random Gene Permutation Test

Compare case-enrichment in 85 AD genes vs randomly selected gene sets.
This tests whether the 71.3% case-enrichment is specific to AD genes.
...
FULL_DATA = '/N/project/ADSP-AI/LD-rarevariant-5th-all/analysis/comprehensive_analysis_FULL_1.8M/merged_plink_alphgenome_1.8M.csv'
AD_GENE_LIST = '/N/project/AiLab/alphagenome/data/Supplementary_Table_S1_GeneList.csv'
OUT_DIR = '/N/project/AiLab/alphagenome/results/continuous_analysis'
...
def calculate_case_enrichment(df, gene_list):
    """Calculate % of variants with cc_ratio > 1 for given genes."""
